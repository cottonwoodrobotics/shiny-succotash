...
public class TeleopArm extends CommandBase {
  ...
  public void execute() {
    ...
    // :D YSeah this looks terrible, but I'm just intending to set up quick manual controls so The Underdogs can test
    if(Math.abs(controller.getRightY())>0.1){
      this.armSubsystem.manualExtend(-controller.getRightY()/-15);
    }
